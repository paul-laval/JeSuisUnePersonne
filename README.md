...
[https://jesuisunepersonne.fr/](https://jesuisunepersonne.fr/): Le site de détection de robots personnalisé
...
* Si le décompte du délai et le reCAPTCHA avec la coche "Je ne suis pas un robot" sont présents, c'est qu'il ne s'est toujours pas identifié. Un bouton "Rafraichir" permet d'actualiser, de mettre à jour, ce contrôle.
